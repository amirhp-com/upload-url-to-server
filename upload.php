...
define('APP_VER','1.9.2');
define('BUILD_DATE','released on 2026-04-30 &middot; 1405-02-10');
...
<style>*,*::before,*::after{box-sizing:border-box;margin:0;padding:0}:root{--bg:#0d1117;--s1:#161b22;--s2:#21262d;--bd:#30363d;--t1:#e6edf3;--t2:#8b949e;--ac:#e3650b;--gr:#3fb950;--rd:#f85149;--rw:#c7ff01;--bl:#58a6ff}body{background:var(--bg);color:var(--t1);font-family:-apple-system,BlinkMacSystemFont,'SF Pro Display','Segoe UI',system-ui,sans-serif;font-size:16px;line-height:1.5;min-height:100vh}a{color:var(--bl);text-decoration:none}a:hover{text-decoration:underline}#pgbar{position:absolute;bottom:-4px;left:0;width:0;height:3px;background:linear-gradient(90deg,#f0883e,#f5c47a);z-index:9999;transition:width .25s ease;pointer-events:none;box-shadow:0 0 8px rgba(240,136,62,.5)}.hdr{display:flex;align-items:center;justify-content:space-between;padding:.65rem 1.5rem;background:var(--s1);border-bottom:1px solid var(--bd);position:sticky;top:0;z-index:100;gap:.75rem}.hdr-logo{display:flex;align-items:center;gap:.45rem;text-decoration:none;flex-shrink:0}.hdr-logo img{width:24px;height:24px}.hdr-title{font-size:.92rem;font-weight:700;color:var(--t1);letter-spacing:-.3px}.hdr-nav{display:flex;gap:.35rem;align-items:center;flex-wrap:wrap}.ip-badge{font-size:.7rem;color:var(--t2);padding:.2rem .55rem;background:var(--s2);border:1px solid var(--bd);border-radius:20px;font-family:ui-monospace,SFMono-Regular,Menlo,monospace}.main{max-width:600px;margin:0 auto;padding:2rem 1rem 1rem}.page-hd{text-align:center;margin-bottom:1.5rem}.page-hd h1{font-size:1.25rem;font-weight:900;color:var(--t1);display:flex;flex-direction:column;align-items:center;justify-content:center;gap:.45rem}.page-hd img{width:72px;height:auto;display:block}.page-hd p{font-size:.78rem;color:var(--t2);margin-top:.3rem}.field{margin-bottom:.85rem}.field label{display:block;font-size:.68rem;font-weight:700;color:var(--t2);text-transform:uppercase;letter-spacing:.6px;margin-bottom:.32rem}.field input{width:100%;padding:.6rem .85rem;background:var(--s2);border:1px solid var(--bd);border-radius:10px;color:var(--t1);font-size:.9rem;outline:none;transition:border-color .15s,box-shadow .15s;-webkit-appearance:none}.field input:focus{border-color:var(--ac);box-shadow:0 0 0 3px rgba(240,136,62,.15)}.field input::placeholder{color:var(--t2)}.toggle-row{display:flex;align-items:center;justify-content:space-between;padding:.65rem .95rem;background:var(--s1);border:1px solid var(--bd);border-radius:12px;margin-bottom:.55rem;gap:1rem}.tgl-lbl{font-size:.86rem;color:var(--t1);flex:1}.tgl-hint{display:block;font-size:.71rem;color:var(--t2);margin-top:2px}.sw{position:relative;display:inline-block;width:51px;height:31px;flex-shrink:0}.sw input{opacity:0;width:0;height:0}.sw-s{position:absolute;cursor:pointer;inset:0;background:#3a3a3c;border-radius:31px;transition:background .25s}.sw-s::before{content:'';position:absolute;width:27px;height:27px;bottom:2px;left:2px;background:#fff;border-radius:50%;box-shadow:0 3px 8px rgba(0,0,0,.4);transition:transform .25s cubic-bezier(.32,.72,0,1)}.sw input:checked+.sw-s{background:var(--gr)}.sw input:checked+.sw-s::before{transform:translateX(20px)}.btn{display:inline-flex;align-items:center;justify-content:center;gap:.32rem;padding:.52rem 1.2rem;border:none;border-radius:980px;font-size:.86rem;font-weight:500;cursor:pointer;text-decoration:none;transition:opacity .15s,transform .1s;white-space:nowrap;line-height:1}.btn:hover{text-decoration:none;}.btn:active{transform:scale(.96)}.btn-p{background:var(--ac);color:#fff;}.btn-p.root{padding: 1rem 2.5rem}.btn-p:hover{opacity:.88}.btn-g{background:var(--s2);color:var(--t1);border:1px solid var(--bd)}.btn-g:hover{border-color:var(--t2)}.btn-d{background:var(--rd);color:#fff}.btn-d:hover{opacity:.88}.btn-sm{padding:.32rem .8rem;font-size:.76rem}.btn-icon{padding:.38rem .55rem;border-radius:8px}.form-wrap{display:flex;justify-content:center;margin-top:1.1rem}.upload-card{background:var(--s1);border:1px solid var(--bd);border-radius:14px;padding:1.1rem;margin-bottom:.9rem}.upload-meta{font-size:.8rem;color:var(--t2);margin-bottom:.75rem;line-height:1.65}.upload-meta a{color:var(--bl)}.upload-meta strong{color:var(--t1)}#progress{font-size:.95rem;font-weight:700;color:var(--ac);margin:.5rem 0;font-family:ui-monospace,SFMono-Regular,Menlo,monospace}#progress small{font-weight:400;color:var(--t2);font-size:.76rem}.status-line{margin:.22rem 0;font-size:.82rem;color:var(--t2)}.result-box{background:var(--s1);border:1px solid var(--bd);border-radius:12px;padding:.9rem;margin:.75rem 0}.url-row{display:flex;align-items:center;gap:.35rem;margin:.3rem 0}.url-lbl{font-size:.66rem;font-weight:700;color:var(--t2);text-transform:uppercase;letter-spacing:.5px;min-width:72px;flex-shrink:0}.url-inp{flex:1;padding:.35rem .6rem;background:var(--s2);border:1px solid var(--bd);border-radius:7px;color:var(--t1);font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:.75rem;outline:none;min-width:0}.copy-btn{padding:.3rem .7rem;background:var(--s2);color:var(--t2);border:1px solid var(--bd);border-radius:7px;cursor:pointer;font-size:.72rem;transition:background .15s,color .15s;flex-shrink:0;white-space:nowrap}.copy-btn:hover,.copy-btn.ok{background:var(--gr);color:#fff;border-color:var(--gr)}.done-btns{display:flex;flex-wrap:wrap;gap:.45rem;margin-top:.9rem;justify-content:center}.toast{position:fixed;bottom:1.4rem;right:1.4rem;background:var(--s1);color:var(--t1);border:1px solid var(--bd);padding:.6rem 1rem;border-radius:12px;box-shadow:0 8px 28px rgba(0,0,0,.6);transform:translateY(80px);opacity:0;transition:transform .3s cubic-bezier(.32,.72,0,1),opacity .25s;z-index:9999;font-size:.82rem;pointer-events:none}.toast.show{transform:translateY(0);opacity:1}.modal-bg{position:fixed;inset:0;background:rgba(0,0,0,.72);backdrop-filter:blur(6px);z-index:200;display:none;align-items:flex-start;justify-content:center;padding:1rem;overflow-y:auto}.modal-bg.open{display:flex}.modal{background:var(--s1);border:1px solid var(--bd);border-radius:16px;width:100%;max-width:860px;margin:auto;display:flex;flex-direction:column;overflow:hidden}.modal-hdr{display:flex;align-items:center;justify-content:space-between;padding:.85rem 1.1rem;border-bottom:1px solid var(--bd);flex-shrink:0}.modal-hdr h3{font-size:.9rem;font-weight:700;color:var(--t1)}.modal-hdr-r{display:flex;gap:.35rem;align-items:center}.modal-body{overflow-y:auto;padding:.9rem 1.1rem;max-height:78vh}.modal-x{background:none;border:none;color:var(--t2);cursor:pointer;font-size:1rem;padding:.22rem .4rem;border-radius:6px;line-height:1}.modal-x:hover{color:var(--t1);background:var(--s2)}.info-grid{display:grid;grid-template-columns:1fr 1fr;gap:.65rem}.info-panel{background:var(--s2);border-radius:9px;overflow:hidden;border:1px solid var(--bd)}.info-panel h4{padding:.45rem .85rem;background:var(--s1);font-size:.67rem;font-weight:700;text-transform:uppercase;letter-spacing:.6px;color:var(--t2);border-bottom:1px solid var(--bd);margin:0}.info-panel table{width:100%;border-collapse:collapse;font-family:ui-monospace,SFMono-Regular,Menlo,monospace}.info-panel td{padding:.3rem .85rem;border-bottom:1px solid var(--bd);font-size:.72rem;vertical-align:top;word-break:break-all}.info-panel td:first-child{color:var(--t2);width:140px;word-break:normal;white-space:nowrap}.info-panel tr:last-child td{border-bottom:none}@media(max-width:580px){.info-grid{grid-template-columns:1fr}}.fb-bar{display:flex;align-items:center;gap:.4rem;margin-bottom:.55rem;flex-wrap:wrap}.fb-path{display:flex;align-items:center;gap:.22rem;flex-wrap:wrap;padding:.4rem .7rem;background:var(--s2);border-radius:8px;font-size:.75rem;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;flex:1;min-width:0}.fb-crumb{color:var(--bl);cursor:pointer;white-space:nowrap}.fb-crumb:hover{text-decoration:underline}.fb-sep{color:var(--t2)}.fb-bulk{display:none;align-items:center;gap:.38rem;padding:.38rem .7rem;background:var(--s2);border:1px solid var(--bd);border-radius:8px;margin-bottom:.45rem;font-size:.78rem;color:var(--t2)}.fb-bulk.show{display:flex}.fb-tbl{width:100%;border-collapse:collapse}.fb-tbl th{padding:.38rem .6rem;text-align:left;font-size:.65rem;font-weight:700;text-transform:uppercase;letter-spacing:.5px;color:var(--t2);border-bottom:1px solid var(--bd)}.fb-tbl td{padding:.42rem .6rem;border-bottom:1px solid var(--bd);font-size:.8rem;vertical-align:middle}.fb-tbl tr:last-child td{border-bottom:none}.fb-tbl tbody tr:hover td{background:rgba(255,255,255,.025)}.fb-dn{color:var(--ac);cursor:pointer}.fb-dn:hover{text-decoration:underline}.fb-fn{color:var(--t1)}.fb-sz{color:var(--t2);font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:.72rem;white-space:nowrap}.fb-mt{color:var(--t2);font-size:.72rem;white-space:nowrap}.fb-acts{display:flex;gap:.22rem;justify-content:flex-end}.fb-empty{text-align:center;padding:2rem;color:var(--t2);font-size:.82rem}.help-sec{margin-bottom:1.1rem}.help-sec h4{font-size:.74rem;font-weight:700;color:var(--ac);text-transform:uppercase;letter-spacing:.5px;margin-bottom:.45rem}.help-code{background:var(--s2);border:1px solid var(--bd);border-radius:8px;padding:.7rem .95rem;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:.76rem;color:var(--t1);overflow-x:auto;white-space:pre;line-height:1.65}.red-warn{color:var(--rw);padding:.65rem .95rem;background:var(--s1);border:1px solid var(--bd);border-radius:12px;font-size:.7rem;font-weight:700;text-transform:uppercase;text-align:center;margin:1.8rem auto .8rem;display:block;}.red-warn a{transition:all .3s ease-in-out;color:var(--rd)}.red-warn a:hover{text-decoration:none;color:#bc2019;}.ftr{text-align:center;padding:1.1rem;font-size:.72rem;color:var(--t2);border-top:1px solid var(--bd);}.ftr a{color:var(--t2)}.ftr a:hover{color:var(--t1)}@media(max-width:600px){.hdr{padding:.55rem .9rem}.hdr-title{display:none}.main{padding:1.1rem .7rem .7rem}.hdr-nav{gap:.22rem}.btn-sm{padding:.28rem .6rem;font-size:.7rem}}
.flex-du{display:flex;flex-direction:row;gap:1rem;}.flex-du>div{flex: 1 1 45%;}@media only screen and (max-width:600px){.flex-du{flex-direction:column;gap:0.25rem;}}</style>
<script>
...
function copyText(text,btn){
  var done=function(){if(btn){btn.classList.add('ok');var o=btn.textContent;btn.textContent='✓';setTimeout(function(){btn.textContent=o;btn.classList.remove('ok');},1500);} if(!btn){showToast('Copied to clipboard');}};
...
function fbRender(d){
  ...
  var crumbs='<span class="fb-crumb" onclick="fbLoad(\'__ROOT__\')">🏠 root</span>';
  ...
  if(d.parent!==null&&d.parent!==undefined){
    ...
    h+='<tr><td></td><td colspan="3"><span class="fb-dn" onclick=\'fbLoad('+JSON.stringify(pp)+')\'>📂 ..</span></td><td></td></tr>';
  }
  if(!d.items||!d.items.length){h+='<tr><td colspan="5" class="fb-empty">Empty directory</td></tr>';}
  else{
    d.items.forEach(function(item){
      var isDir=item.type==='dir';
      var nm=isDir?'<span class="fb-dn" onclick=\'fbLoad('+JSON.stringify(item.path)+')\'>📂 '+_esc(item.name)+'</span>':'<span class="fb-fn">📄 '+_esc(item.name)+'</span>';
      ...
      h+='<tr data-path="'+pathAttr+'" data-url="'+urlAttr+'">'
        ...
        +'<td class="fb-acts">'
        +(item.url?'<button class="btn btn-g btn-sm btn-icon copy-btn" title="Copy URL" onclick=\'copyText('+JSON.stringify(item.url)+', this)\'>&#128203;</button>':'')
        +'<button class="btn btn-d btn-sm btn-icon" title="Delete" onclick=\'fbDel('+JSON.stringify(item.path)+','+JSON.stringify(item.name)+')\'>&#10005;</button>'
        +'</td></tr>';
    });
  }
  h+='</tbody></table>';
...
<header class="hdr">
  ...
  <nav class="hdr-nav">
    ...
    <button class="btn btn-g btn-sm" onclick="openFileBrowser()">🗂️ File Explorer</button>
    <button class="btn btn-g btn-sm" onclick="openInfoModal()">⚙️ PHP Info</button>
    <button class="btn btn-g btn-sm" onclick="openModal('modal-help')">🛂 Help</button>
  </nav>
  <div id="pgbar"></div>
</header>
<main class="main">
...
if(isset($_POST['url'],$_POST['name'])){
  ...
  echo '<div class="upload-meta">From: <a href="'.$pre_url.'" target="_blank" rel="noopener">'.$pre_url.'</a><br>To: <strong>'.$pre_dest.'</strong><br><span style="font-size:.72rem;margin-top:.3rem;display:block">Please wait or press ESC to cancel</span></div>';
  ...
  <div class="modal" style="max-width:920px">
    <div class="modal-hdr">
      ...
      <div class="modal-hdr-r">
        <a class="btn btn-g btn-sm" href="?phpinfo=1" target="_blank" rel="noopener">Full phpInfo() &#8599;</a>
        <button class="modal-x" onclick="closeModal('modal-info')">&#10005;</button>
      </div>
    </div>
...
<div class="modal-bg" id="modal-fb" onclick="if(event.target===this)closeModal('modal-fb')">
  <div class="modal" style="max-width:940px">
    <div class="modal-hdr">
      <h3>&#128193; File Browser</h3>
      <button class="modal-x" onclick="closeModal('modal-fb')">&#10005;</button>
    </div>
    <div class="modal-body">
      <div class="fb-bar">
        <div id="fb-path" class="fb-path"><span style="color:var(--t2)">Loading&hellip;</span></div>
        <button class="btn btn-g btn-sm" onclick="fbLoad(fbCwd)">&#8635;</button>
      </div>
      <div id="fb-bulk" class="fb-bulk">
        <span id="fb-sel-n"></span>
        <button class="btn btn-g btn-sm" onclick="fbCopySelected()">&#128203; Copy URLs</button>
        <button class="btn btn-d btn-sm" onclick="fbDelSelected()">&#10005; Delete</button>
      </div>
...
<div class="modal-bg" id="modal-help" onclick="if(event.target===this)closeModal('modal-help')">
  <div class="modal" style="max-width:680px">
    <div class="modal-hdr">
      <h3>? Help &amp; CLI Guide</h3>
      <button class="modal-x" onclick="closeModal('modal-help')">&#10005;</button>
    </div>
    <div class="modal-body">
...
php upload.php --url=https://example.com/archive.tar.gz --name=a.tar.gz --extract</div></div>
...
function render_form(){
  ...
  ?>
  <form name="upload" method="post" action="<?=$action?>">
    ...
    <div class="form-wrap"><button type="submit" class="btn btn-p root" tabindex="6">&#8679; Upload File</button></div>
  </form>
  <script>
  setTimeout(function(){var u=document.querySelector('#url');if(u)u.select();},200);
  (function(){var u=document.querySelector('#url'),n=document.querySelector('#name');
  function sync(){var v=u.value.split('?')[0].split('#')[0].split('/').pop();if(v)n.value=v;}
  u.addEventListener('change',sync);u.addEventListener('keyup',sync);})();
  </script>
  <?php
}
...
function render_completion_buttons($path_full=''){
  $del='';
  ...
  $btns='<div class="done-btns">'
    .'<a href="?r='.time().'" class="btn btn-p">Upload Another</a>'
    .$del
...
function ajax_ls(){
  ...
  foreach($entries as $entry){
    ...
    $sz=$is_dir?0:@filesize($full);$mt=@filemtime($full);
    $url='';
    if(!$is_dir){
...
function cli_main(){
  $opts=getopt('',['url:','name:','folder:','extract','wpinstall','delete','help']);
  if(isset($opts['help'])||(!isset($opts['url'])&&!isset($opts['delete']))){
    echo "BlackSwan Upload v".APP_VER."\n\n";
    echo "Usage: php upload.php --url=<URL> --name=<filename> [options]\n\n";
    echo "  --url=<URL>        Source URL (required)\n";
